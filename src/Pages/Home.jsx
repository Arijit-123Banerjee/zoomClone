  ...
  return (
    <>
      <div className="h-screen flex justify-center items-center flex-col p-8 md:p-20 lg:p-44">
        ...
        <h1 className="typing-effect font-bold text-[24px] sm:text-[28px] md:text-[32px] lg:text-[48px] xl:text-[60px] text-slate-700 text-center">
          Revolutionize <span className="text-[#007dfc]">Your Workflow</span>
        </h1>
